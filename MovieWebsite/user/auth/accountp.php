...
<body>
  ...
  <div class="container">
    ...
    echo "  <form  action='update.php' method='POST'>
          ...
          <br>
          <input type='text' class='form-control' placeholder='Số điện thoại' name='phn' value='" . $result['phone'] . "'>
          <br>
          <label><b>Ngày sinh: </b></label>
          <input type='text' class='from-control' placeholder='Nhập' name='dob' value='" . $result['DOB'] . "'><br>
              ...
              <form class='' action='updatep.php' method='post'>
                <input type='password' class='form-control' placeholder='Nhập mật khẩu cũ' name='oldp'><br>
                <input type='password' class='form-control' placeholder='Nhập mật khẩu mới' name='newp'><br>
                <button type='submit' class='btn btn-success ' name='subpass' value='submit'>Đổi mật khẩu</button><br>
